...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [{ url: '/nexo-pwa-final.png', sizes: '192x192', type: 'image/png' }],
    apple: [{ url: '/apple-touch-icon-final.png', sizes: '180x180', type: 'image/png' }],
    shortcut: ['/nexo-pwa-final.png'],
  },
  ...
  return (
    <html lang="es" suppressHydrationWarning>
      <head>
        ...
        <link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon-final.png" />
        <link rel="apple-touch-icon-precomposed" sizes="180x180" href="/apple-touch-icon-final.png" />
        <link rel="icon" type="image/png" sizes="192x192" href="/nexo-pwa-final.png" />
        <link rel="shortcut icon" type="image/png" href="/nexo-pwa-final.png" />
